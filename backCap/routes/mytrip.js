...
router.post("/", ensureAdmin, async function (req, res, next) {
    ...
    const { tripName, tripDate, username, flightReservation_id, hotelReservation_id, carRental_id } = req.body;
  ...
  router.get("/:trip/<int:id>", async function (req, res, next) {
    try {
  ...
  router.patch("/:trip/<int:id>", ensureAdmin, async function (req, res, next) {
    try {
    //CHANGE the NAME OF the TRIP
   //CHANGE the DATE
   const {  tripName, tripDate  } = req.params;
  ...
  router.delete("/:trip", ensureCorrectUserOrAdmin, async function (req, res, next) {
    try {
      const { id } = req.params;
  ...
  router.post("/:trip/<int:id>/flights/:id", ensureCorrectUserOrAdmin, async function (req, res, next) {
    try {
  ...
  // HOTEL
  router.post("/:trip/<int:id>/hotels/:id", ensureCorrectUserOrAdmin, async function (req, res, next) {
    try {
...
//   CAR
  router.post("/:trip/<int:id>/cars/:id", ensureCorrectUserOrAdmin, async function (req, res, next) {
    try {
