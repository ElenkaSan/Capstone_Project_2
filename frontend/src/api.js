...
static async callApiAirport(city) {
...
static async Autocomplete() {
  let res = await this.frontendRequest(`/api/autocomplete`);
  return res.flights;
}
...
// }
  ...
  static async getHotels() {
    // let res = await this.frontendRequest(`hotels/locations`);
    let res = await this.frontendRequest(`hotels/get-details`);
    return res.hotels;
  }
  
  static async getFilteredHotels(formData) {
    // let res = await this.frontendRequest(`hotels/search`, { id });
    let res = await this.frontendRequest(`hotels/list`, { formData });
    return res.hotels;
  }
