...
const SearchCars = ({findCars, resetCarsList}) =>  {
    ...
    return (
        ...
        {/* <div className="input-group"> */}
                    ...
                    <h5 className="card text-center text-light bg-secondary p-1">Location Pickup</h5> 
                    </Label> 
                    ...
                    <h5 className='card text-center text-light bg-secondary p-1'>Location Dropoff</h5>
                    </Label> 
                      <Input
                 ...
                 {/* <span className="input-group-btn" style={{width:'20px'}}></span> */}
                    ...
                    <h5 className='card text-center text-light bg-secondary'>Pick-up Time</h5>
                      <Input className="form-control mb-3 mp-3"
                          id="dateTimeP"
                          type="time"
                          name="dateTimeP"
                   ...
                   <h5 className='card text-center text-light bg-secondary'> Drop-off Time</h5>
                    ...
                    {/* <div className="input-group"> */}
                    <Label htmlFor="dateTimeP">     
                    <h5 className='card text-center text-light bg-secondary'>Pick-up Date </h5>
                      <Input className="form-control"
                        id="dateTimeP"
                        type="date"
                        name="dateTimeP"
                      ...
                      <span className="input-group-btn" style={{width:'20px'}}></span>
                      <Label htmlFor="dateTimeR">    
                      <h5 className='card text-center text-light bg-secondary'>Drop-off Date </h5>
                      <Input className="form-control"
                        id="dateTimeR"
                        type="date"
                        name="dateTimeR"
