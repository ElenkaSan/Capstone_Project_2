                   ...
                   <div className="input-group">
                     ...
                     <Input className="input mb-3"
                      ...
                      <Input className="input mb-3"
                        ...
                        placeholder="Number of Traveling"
                        min="0"
                        max="100"
                    ...
                    <h5 className='T text-light'>Cabin Class </h5>               
                    ...
                    <Button className="float-right btn btn-outline-danger" onClick={() => resetFlightsList()}>Clear Filter</Button>
                    </div>
                </FormGroup>
            </Form>
          </CardBody>
